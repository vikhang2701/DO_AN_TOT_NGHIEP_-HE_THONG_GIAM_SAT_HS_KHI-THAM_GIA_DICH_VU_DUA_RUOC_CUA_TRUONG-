...
#define WIFI_SSID "OPPO Reno8 T" //OPPO Reno8 T
#define WIFI_PASSWORD "a2wngyct" //a2wngyct
...
String number_ph= "0987045339";  //0987045339
String h;
...
int numberOfReadings = 100; // Số lần đọc cho bộ lọc trung bình
int number_vol = 100; // Số lần đọc cho bộ lọc trung bình
float calibration = 0.68; // Check Battery voltage using multimeter & add/subtract the value
 ...
 void get_location()
{
    if(gps.location.isValid())  
  {
    ...
    Firebase.setFloat(firebaseData, "/GPS/VIDOCUAXE1", latitude);
    Firebase.setFloat(firebaseData, "/GPS/KINHDOCUAXE1", longitude);
  }
  else {
    GPS_NO(); 
    Firebase.setString(firebaseData, path + "/GPS/KINHDOCUAXE1","'KHÔNG THẤY'"); 
    Firebase.setString(firebaseData, path + "/GPS/VIDOCUAXE1","'KHÔNG THẤY'"); 
      }
}
...
void hocSinh1(){
  ...
  dem1++;
        ...
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de den truong/Ten hoc sinh 1/Ho va ten", "'Trần Trung Tín'");    
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 1/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 1/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS1",dem1);   
        }
        else if (tam1==2)
        {
        ...
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 1/Ho va ten", "'Trần Trung Tín'");    
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 1/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 1/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS1",dem1);  
        }              
        else if (tam1==1){
        ...
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 1/Ho va ten", "'Trần Trung Tín'");    
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 1/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 1/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS1",dem1); 
        ...
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 1/Ho va ten", "'Trần Trung Tín'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 1/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 1/date", dateStr);
...
void hocSinh2(){
  ...
  if (tam2==0){
    ...
    tft.setTextSize(2);
    tft.printf("DA LEN XE DE DEN TRUONG");
    Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de den truong/Ten hoc sinh 2/Ho va ten", "'Phạm Hoàng Vĩ Khang'");
    Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 2/time", timeStr);
    Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 2/date", dateStr);
    Firebase.setInt(firebaseData, path + "/CHECK/HS2",dem2);          
    }
   else if (tam2==2)
    {
     ...
     tft.setTextSize(2);
     tft.printf("DA LEN XE DE VE NHA");
     Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 2/Ho va ten", "'Phạm Hoàng Vĩ Khang'");   
     Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 2/time", timeStr);
     Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 2/date", dateStr);
     Firebase.setInt(firebaseData, path + "/CHECK/HS2",dem2);         
    }       
     else if (tam2==1){
     tft.drawRect(84,120,310,30, TFT_YELLOW);
     ...
     tft.setTextSize(2);
     tft.printf("DA XUONG XE DE DEN TRUONG");    
     Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 2/Ho va ten", "'Phạm Hoàng Vĩ Khang'"); 
     Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 2/time", timeStr);
     Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 2/date", dateStr);
     ...
     else if(tam2==3)
     {
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE VE NHA");
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 2/Ho va ten", "'Phạm Hoàng Vĩ Khang'");     
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 2/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 2/date", dateStr);
...
void hocSinh3(){
  ...
  dem3++;
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE DEN TRUONG");  
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de den truong/Ten hoc sinh 3/Ho va ten", "'Võ Phan Trí Nguyên'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 3/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 3/date", dateStr);  
        Firebase.setInt(firebaseData, path + "/CHECK/HS3",dem3);       
        }
        else if (tam3==2)
        {
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE VE NHA");  
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 3/Ho va ten", "'Võ Phan Trí Nguyên'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 3/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 3/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS3",dem3);    
        }      
        else if (tam3==1){
        tft.drawRect(84,120,310,30, TFT_YELLOW);
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE DEN TRUONG");
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 3/Ho va ten", "'Võ Phan Trí Nguyên'");     
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 3/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 3/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS3",dem3);
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE VE NHA"); 
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 3/Ho va ten", "'Võ Phan Trí Nguyên'");  
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 3/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 3/date", dateStr);
...
void hocSinh4(){
  ...
  dem4++;
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE DEN TRUONG");  
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de den truong/Ten hoc sinh 4/Ho va ten", "'Phạm Nguyễn Thế Anh'");   
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 4/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 4/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS4",dem4);     
        }
        else if (tam4==2)
        {
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE VE NHA"); 
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 4/Ho va ten", "'Phạm Nguyễn Thế Anh'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 4/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 4/date", dateStr);  
        Firebase.setInt(firebaseData, path + "/CHECK/HS4",dem4);          
        }             
        else if (tam4==1){
        tft.drawRect(84,120,310,30, TFT_YELLOW);
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE DEN TRUONG");
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 4/Ho va ten", "'Phạm Nguyễn Thế Anh'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 4/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 4/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS4",dem4); 
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE VE NHA");
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 4/Ho va ten", "'Phạm Nguyễn Thế Anh'");   
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 4/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 4/date", dateStr);
...
void hocSinh5(){
  ...
  dem5++;
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE DEN TRUONG");   
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de den truong/Ten hoc sinh 5/Ho va ten", "'Vũ Cao Minh'");  
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 5/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 5/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS5",dem5);         
        }
        else if (tam5==2)
        {
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE VE NHA");   
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 5/Ho va ten", "'Vũ Cao Minh'");  
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 5/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 5/date", dateStr);  
        Firebase.setInt(firebaseData, path + "/CHECK/HS5",dem5);     
      }     
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE DEN TRUONG");
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 5/Ho va ten", "'Vũ Cao Minh'");  
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 5/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 5/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS5",dem5);  
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE VE NHA"); 
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 5/Ho va ten", "'Vũ Cao Minh'");  
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 5/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 5/date", dateStr);
...
void hocSinh6(){
  ...
  dem6++;
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE DEN TRUONG"); 
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de den truong/Ten hoc sinh 6/Ho va ten", "'Đoàn Ngọc Tường'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 6/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 6/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS6",dem6);          
        }
        else if (tam6==2)
        {
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE VE NHA");  
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 6/Ho va ten", "'Đoàn Ngọc Tường'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 6/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 6/date", dateStr);\
        Firebase.setInt(firebaseData, path + "/CHECK/HS6",dem6);          
        }          
        else if (tam6==1){
        tft.drawRect(84,120,310,30, TFT_YELLOW);
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE DEN TRUONG");
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 6/Ho va ten", "'Đoàn Ngọc Tường'");     
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 6/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 6/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS6",dem6); 
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE VE NHA");   
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 6/Ho va ten", "'Đoàn Ngọc Tường'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 6/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 6/date", dateStr);
...
void hocSinh7(){
  ...
  dem7++;
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE DEN TRUONG"); 
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de den truong/Ten hoc sinh 7/Ho va ten", "'Nguyễn Tấn Lộc'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 7/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 7/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS7",dem7);          
        }
        else if (tam7==2)
        {
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE VE NHA"); 
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 7/Ho va ten", "'Nguyễn Tấn Lộc'");   
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 7/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 7/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS7",dem7);   
        }      
      else if (tam7==1){ 
        tft.drawRect(84,120,310,30, TFT_YELLOW);
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE DEN TRUONG");  
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 7/Ho va ten", "'Nguyễn Tấn Lộc'");   
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 7/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 7/date", dateStr);
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE VE NHA");
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 7/Ho va ten", "'Nguyễn Tấn Lộc'");   
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 7/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 7/date", dateStr);
...
void hocSinh8(){
  ...
  dem8++;
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE DEN TRUONG");    
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de den truong/Ten hoc sinh 8/Ho va ten", "'Nguyễn Phi Hùng Kiệt'");  
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 8/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 8/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS8",dem8);     
        }
        else if (tam8==2)
        {
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE VE NHA");    
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 8/Ho va ten", "'Nguyễn Phi Hùng Kiệt'");
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 8/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 8/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS8",dem8);   
        }         
        else if (tam8==1){
        tft.drawRect(84,120,310,30, TFT_YELLOW);
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE DEN TRUONG"); 
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 8/Ho va ten", "'Nguyễn Phi Hùng Kiệt'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 8/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 8/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS8",dem8); 
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE VE NHA");  
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 8/Ho va ten", "'Nguyễn Phi Hùng Kiệt'");  
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 8/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 8/date", dateStr);
...
void hocSinh9(){
  ...
  dem9++;
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE DEN TRUONG");  
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de den truong/Ten hoc sinh 9/Ho va ten", "'Tôn Thất Ngọc Hải'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 9/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 9/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS9",dem9);         
        }
        else if (tam9==2)
        {
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE VE NHA");   
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 9/Ho va ten", "'Tôn Thất Ngọc Hải'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 9/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 9/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS9",dem9);   
        }      
        else if (tam9==1){
        tft.drawRect(84,120,310,30, TFT_YELLOW);
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE DEN TRUONG");   
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 9/Ho va ten", "'Tôn Thất Ngọc Hải'");  
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 9/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 9/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS9",dem9);
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE VE NHA");   
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 9/Ho va ten", "'Tôn Thất Ngọc Hải'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 9/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 9/date", dateStr);
...
void hocSinh10(){
  ...
  dem10++;
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE DEN TRUONG");  
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de den truong/Ten hoc sinh 10/Ho va ten", "'Đỗ Ngọc An'");  
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 10/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de den truong/Ten hoc sinh 10/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS10",dem10);        
        }
        else if (tam10==2)
        {
        ...
        tft.setTextSize(2);
        tft.printf("DA LEN XE DE VE NHA");  
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 10/Ho va ten", "'Đỗ Ngọc An'");   
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 10/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh len xe de ve nha/Ten hoc sinh 10/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS10",dem10);  
        }          
        else if (tam10==1){
        tft.drawRect(84,120,310,30, TFT_YELLOW);
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE DEN TRUONG");  
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 10/Ho va ten", "'Đỗ Ngọc An'"); 
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 10/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de den truong/Ten hoc sinh 10/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/HS10",dem10);
        ...
        tft.setTextSize(2);
        tft.printf("DA XUONG XE DE VE NHA"); 
        Firebase.setString(firebaseData, path + "Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 10/Ho va ten", "'Đỗ Ngọc An'");
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 10/time", timeStr);
        Firebase.setString(firebaseData, "/Danh sach hoc sinh xuong xe de ve nha/Ten hoc sinh 10/date", dateStr);
...
void taiXe1() {
  ...
  if (tamtx1 == 0){
        ...
        Firebase.setString(firebaseData, path + "Thong tin cua xe/Loai xe", "HYUNDAI");
        Firebase.setString(firebaseData, path + "Thong tin cua xe/So dien thoai tai xe", "'0333617584'");
        Firebase.setString(firebaseData, "/Thong tin cua xe/Thoi gian tai xe len xe/time", timeStr);
        Firebase.setString(firebaseData, "/Thong tin cua xe/Thoi gian tai xe len xe/date", dateStr);
        Firebase.setInt(firebaseData, path + "/CHECK/TX1",demtx1);  
        h="hanh";
  }
  else if(tamtx1 == 1){
...
void goithatbai_ph(){
 ...
 void pin() 
 {
  ...
  for (int i = 0; i < number_vol; i++) {
    ...
    if (i > 0 && abs(newVoltage - previousVoltage) > 0.002) {
      // Bỏ qua giá trị
      continue;
    }
  ...
  bat_percentage = mapfloat(voltage,3.35,3.95, 0, 100); //2.8V as Battery Cut off Voltage & 4.2V as Maximum Voltage
  ...
  // In giá trị điện áp và tỉ lệ sạc lên màn hình
    ...
    tft.setTextColor(TFT_BLACK);
    tft.setTextSize(2);                                  
    tft.println((String(bat_percentage) + "%")); //voltage
